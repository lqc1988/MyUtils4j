...
public class QRCodeUtils {
     ...
     * @return 二维码图片的字节数组
     */
    public static File createQRCode(String content, int length, File logoFile, MatrixToLogoImageConfig config) {
     ...
     * @return 二维码图片的字节数组
     */
    public static File createQRCode(String content, int length, File logoFile) {
     ...
     * @return 二维码图片的字节数组
     */
    public static File createQRCode(String content, File logoFile, MatrixToLogoImageConfig config) {
     ...
     * @return 二维码图片的字节数组
     */
    public static File createQRCode(String content, File logoFile) {
    ...
    public static void main(String[] args) {
        ...
        File logFile = new File("/data/app/hxcenterFile/template/logo_hxdf.jpg");
        if (!logFile.exists()) {
            logger.error("logo文件不存在");
            return;
        }
        MatrixToLogoImageConfig config = new MatrixToLogoImageConfig(0, Color.LIGHT_GRAY);
        createQRCode("https://api-park-test.hejiahuan.cn/", logFile, config);
    }
}
