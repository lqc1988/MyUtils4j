...
public class OSSClientUtil {
    ...
    public OSSClientUtil() {
        ...
        DefaultCredentialProvider credentialsProvider = new DefaultCredentialProvider(ConstUtil.oss_access_key_id.trim(),
                ConstUtil.oss_access_key_secret.trim());
...
//		request.addUserMetadata("author", "aliy");
     ...
     * @return
     */
    public void authUpload(URL url) {
